...
public class ElementUtil {
	...
	public WebElement getElement(By locator) {
	 ...
	 public void waitForTextInElementValue(By locator, int timeOut, String value) {
	...
	public void hardWait(int seconds) {
	    try {
	        // Create a wait that times out after the specified number of seconds
	        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(seconds));
	        // Use a lambda that always returns false, causing the wait to time out
	        wait.until(driver -> false);
	    } catch (Exception e) {
	        // We expect a timeout exception here, so just ignore it
	    }
	}
